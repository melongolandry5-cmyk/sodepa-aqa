...
test.describe('API — Surface exposée', () => {
  test('chaque route des contrôleurs Spring est couverte par le registre', () => {
    ...
    expect(routesJava!.length, 'aucune route détectée : le parseur est à revoir').toBeGreaterThan(
      0,
    );
